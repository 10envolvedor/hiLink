...
function ActionMenu({ button, children, offset = 12, onAction }) {
      ...
      {visible &&
        ReactDOM.createPortal(
          <div
            ...
            style={styles.popper}
            {...attributes.popper}
            className="bg-black text-white px-2 py-1 rounded-md text-sm shadow-lg flex flex-col items-center content-center align-center justify-center"
          >
            ...
            <button onClick={toogleTooltip} className="text-white text-sm">
              <SquareIcon
